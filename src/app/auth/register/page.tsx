...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-surface-container-low to-background py-12">
          ...
          <div className="card-body">
            <form action={registerAction} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName" className="block text-label-md text-gray-700 mb-2">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-label-md text-gray-700 mb-2">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              {/* Role Selection */}
              <div>
                <label htmlFor="role" className="block text-label-md text-gray-700 mb-2">
                  I am a
                </label>
                <select
                  id="role"
              ...
              <div>
                <label htmlFor="organisationName" className="block text-label-md text-gray-700 mb-2">
              ...
              <div className="flex items-start">
                ...
                />
                <label htmlFor="terms" className="ml-2 text-body-sm text-gray-600">
                  I agree to the{" "}
