      ...
      <main className="min-h-screen">
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-6">Our Mission</h2>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-6">The Problem We Address</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
              <div className="border border-[#E2E8F0] rounded-lg p-6">
                <div className="w-10 h-10 rounded-md bg-surface-container flex items-center justify-center mb-4">
                  <Shield className="h-5 w-5 text-on-surface" />
                </div>
                <h3 className="text-heading-md font-semibold text-on-surface mb-2">Fragile Operations</h3>
              ...
              <div className="border border-[#E2E8F0] rounded-lg p-6">
                <div className="w-10 h-10 rounded-md bg-surface-container flex items-center justify-center mb-4">
                  <RefreshCw className="h-5 w-5 text-on-surface" />
                </div>
                <h3 className="text-heading-md font-semibold text-on-surface mb-2">Uncertain Funding</h3>
                <p className="text-body-md text-on-surface-variant leading-relaxed">
              ...
              <div className="border border-[#E2E8F0] rounded-lg p-6">
                <div className="w-10 h-10 rounded-md bg-surface-container flex items-center justify-center mb-4">
                  <Database className="h-5 w-5 text-on-surface" />
                </div>
                <h3 className="text-heading-md font-semibold text-on-surface mb-2">Reactive Oversight</h3>
                <p className="text-body-md text-on-surface-variant leading-relaxed">
        ...
        <section className="px-6 pb-20">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-8">What We Believe</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {beliefs.map((belief, i) => (
                ...
                >
                  <h3 className="text-heading-md font-semibold text-on-surface mb-3">
                    {belief.title}
                  </h3>
                  <p className="text-body-md text-on-surface-variant leading-relaxed">
                    {belief.description}
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-6">How We Work</h2>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-6">The Team</h2>
            <p className="text-body-md text-on-surface-variant leading-relaxed">
        ...
        <section className="px-6 pb-20">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-headline-lg font-bold text-on-surface mb-6">How We Build</h2>
            <p className="text-body-md text-on-surface-variant leading-relaxed mb-4">
        ...
        <section className="px-6 pb-28">
          <div className="max-w-7xl mx-auto">
            <div className="bg-primary-container rounded-lg p-10 lg:p-14 text-center">
              <h2 className="text-headline-lg font-bold text-white mb-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-6 py-3 border border-gray-600 text-on-surface-variant/50 font-medium rounded-md hover:bg-primary-container/80 hover:border-gray-500 transition-colors"
                >
                  Request Demo
                </Link>
              </div>
